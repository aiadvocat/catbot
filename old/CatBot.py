...
def store_rag_data_in_pinecone(index_name,rag_data):
    # Initialize Pinecone using the Pinecone class
...
with tab3:
    with st.form("rag_form"):
        ...
        index_name = st.text_area("Enter Pinecone Inded Name", index_name)
        ...
        if submitrag and pinecone_api_key:
            ...
            store_rag_data_in_pinecone(index_name, rag_data)
